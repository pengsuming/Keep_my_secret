...
label 두부2:
    ...
    여주 "그래. 이 저주를 풀려면 내가 쓰레기를 무려 167개나 주워야한다고 ㅠㅠ"
...
label Kending:
    싼다수 "여주얌..ㅠㅠ 나 다시 돌아왔엉\n나 돌아온 기념으로 오늘 데이트 어땡??><><"


label Lending:
    비닐봉지 "야 김여주 도와줘서 고맙다"
    비닐봉지 "그.. 같이 피규어 상점 가는거 어떻냐..?\n너 맘에 드는 거 있음 내가 사준다"


label Hending:
    플라스틱컵 "김여주!! 정말 고마워!!\n너 덕분에 다시 돌아왔어!"
    플라스틱컵 "너 딸기스무디랑 초코케이크 먹고 싶다고 했었지?\n사줄테니 스타벅벅긁스에서 만나!!"
